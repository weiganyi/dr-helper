...
public class ChangeTableService extends Service {
	public String doAction(HttpSession session, String reqBody) {
		...
		try{
			...
			System.out.println("ChangeTableService.doAction(): json parse body failure: " + e.getMessage());
			return respBody;
		}
		...
		if (tableNum1 == 0 || tableNum2 == 0) {
			System.out.println("ChangeTableService.doAction(): tableNum is null");
			return respBody;
		}
		...
		int orderNum = db.changeTable(tableNum1, tableNum2);
		if (orderNum == 0) {
