...
import com.drhelper.service.DeleteOrderService;
...
public class DeleteOrderServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (session == null || session.getAttribute("id") == null) {
			...
			System.out.println("DeleteOrderServlet.doGet(): session isn't exist");
			return;
		}
		...
		if (reqBody.length() == 0) {
			...
			System.out.println("DeleteOrderServlet.doGet(): request body is null");
			return;
		}
		...
		if (respBody == null) {
			response.setStatus(400);
			System.out.println("DeleteOrderServlet.doGet(): response body is null");
			return;
		}
